...
const SEPSP2_CONTRACT_ADDRESS = '0x26Ee65874f5DbEfa629EB103E7BbB2DEAF4fB2c8'; // sePSP2 - op https://optimistic.etherscan.io/address/0x26Ee65874f5DbEfa629EB103E7BbB2DEAF4fB2c8
...
(async () => {
  ...
  while (hasMore) {
    ...
    const sePSP2Balances = await fetchSePSP2Balances(events, opBlocks);
