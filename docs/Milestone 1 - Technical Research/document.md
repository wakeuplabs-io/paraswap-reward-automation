...
> *This automation also accounts the 0.75% monthly fee allocated to WakeUp Labs on the total amount of ETH paid for these Programs. (So, the fee applies for to the Staking Rewards).*
> 
...
> *For a deeper understanding of the Refund Program, we recommend reading: [What is the Gas Refund Program?](https://help.paraswap.xyz/en/articles/6554757-what-is-the-gas-refund-program)*
> 
...
> *Although the POC, in its current state, is 'vague' or may contain calculation or execution errors, it allowed us to validate that the entire flow is possible without the need for human interaction or execution.*
>
