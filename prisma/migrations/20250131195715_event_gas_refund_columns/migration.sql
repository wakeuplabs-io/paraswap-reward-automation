...
INSERT INTO "new_Event" ("blockNumber", "blockTimestamp", "boost", "createdAt", "decodedFunction", "epochActivelyStaking", "ethUsdPrice", "gasPrice", "gasUsed", "input", "pspUsdPrice", "sePSP1AmountEth", "sePSP1AmountOp", "sePSP2AmountEth", "sePSP2AmountOp", "totalPSP", "transactionHash", "type", "user") SELECT "blockNumber", "blockTimestamp", "boost", "createdAt", "decodedFunction", "epochActivelyStaking", "ethUsdPrice", "gasPrice", "gasUsed", "input", "pspUsdPrice", "sePSP1AmountEth", "sePSP1AmountOp", "sePSP2AmountEth", "sePSP2AmountOp", "totalPSP", "transactionHash", "type", "user" FROM "Event";
DROP TABLE "Event";
