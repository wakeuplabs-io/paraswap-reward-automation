/*
  ...
  - You are about to drop the column `sePSP1Amount` on the `Event` table. All the data in the column will be lost.
  - You are about to drop the column `sePSP2Amount` on the `Event` table. All the data in the column will be lost.
